...
public class UserController {
    ...
    public void createNewUser() {
        ...
        UserDepartment department1 = new UserDepartment("DIGITAL");
        departmentService.save(department1);
        UserDepartment department2 = new UserDepartment("BANKING");
        departmentService.save(department2);

        UserRole userRole1 = new UserRole("CONSULTANT");
        roleService.save(userRole1);
        UserRole userRole2 = new UserRole("MANAGER");
        roleService.save(userRole2);
        UserRole userRole3 = new UserRole("ADMINISTRATION");
